...
Entwicklungszeit=Anforderung_Uebersicht{1:Anforderung_ID(i)-1,16};
Training = Training_Values(1:Anforderung_ID(i)-1,:);

%Berechnung des Modellparamter-Vektors b
[b,se,pval,inmodel,stats,nextstep,history] = stepwisefit(Training,Entwicklungszeit);%

%Berechnung der Schätzung auf Grundlage der Modellparameter b 
schaetz_eigenschaften=sum(Training_Values(Anforderung_ID(i),:).*b');
