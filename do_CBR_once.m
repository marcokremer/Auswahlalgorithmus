%CBR Schätzung
function [Entwicklungszeit] = do_CBR_once(Anforderung_ID)
...
Anforderung_value=Training_Values(Anforderung_ID,:);
Vergleichswerte=Training_Values(1:Anforderung_ID-1,:);
ziele_str=Anforderung_Uebersicht.(10){Anforderung_ID};
