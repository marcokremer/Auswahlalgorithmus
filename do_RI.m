...
Anforderung_ID=Anforderung_Uebersicht{contains(cellstr(Anforderung_Uebersicht.(12)),'RI')|contains(cellstr(Anforderung_Uebersicht.(14)),'RI'),1}; 
...
Mdl = fitrtree(Training,Anforderung_Uebersicht(1:Anforderung_ID(i)-1,16),'CategoricalPredictors',categorical_vektor ); %'CrossVal','on',
...
save('RI_Schätzung.mat', 'Ergebnis');