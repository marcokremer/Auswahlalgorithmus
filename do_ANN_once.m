...
function [predAnf]=do_ANN_once(Anforderung_ID)
...
predAnf = ANN_all(Training_Values(Anforderung_ID,:));
%Ergebnis(:)=[table2cell(Anforderung_Uebersicht(Anforderung_ID,1:8)),predAnf];
