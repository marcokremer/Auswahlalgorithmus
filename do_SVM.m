...
Mdl = fitrsvm(Training,Anforderung_Uebersicht(1:Anforderung_ID(i)-1,16),'KernelFunction','gaussian','Standardize',true,'CategoricalPredictors',categorical_vektor ); %'CrossVal','on',
